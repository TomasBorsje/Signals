...
public class SignalsLootTables extends BaseLootTableProvider {
    ...
    protected void addTables() {
        ...
        lootTables.put(Registration.ALUMINIUM_BLOCK.get(), createSimpleTable("aluminium_block", Registration.ALUMINIUM_BLOCK.get()));
        ...
        lootTables.put(Registration.DEEPSLATE_ALUMINIUM_ORE.get(), createSilkTouchTable("deepslate_aluminium_ore", Registration.DEEPSLATE_ALUMINIUM_ORE.get(), Registration.ALUMINIUM_CHUNK.get(), 1, 1));
    }
}
